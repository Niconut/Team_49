...
//@Disabled
@Autonomous
public final class Left_Observation_Auto_Spline extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        Pose2d beginPose = new Pose2d(-37, -62, Math.toRadians(180));
    ...
    public void buildTrajectories(MecanumDrive drive, Pose2d beginPose) {
        ...
        TrajectoryActionBuilder trajectoryDropSamples2 = trajectoryPickUpSamples2.endTrajectory().fresh()
                .setReversed(true)
                .strafeToLinearHeading(new Vector2d(-61, -39), Math.toRadians(45));
