...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -4038.325439586484; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3925.92030525242; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3311.485996155229; // x position of the perpendicular encoder (in tick units)
    }
